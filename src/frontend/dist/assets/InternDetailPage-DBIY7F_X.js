import { c as createLucideIcon, j as jsxRuntimeExports, m as User, a as Badge, k as Eye, b as Button, X, f as cn, r as reactExports, n as ue, L as Link, o as useBackend, p as useQuery, q as convertPerformance, u as useAuth, s as useQueryClient, t as commonjsGlobal, v as getDefaultExportFromCjs, w as clsx, R as React, x as invariant, y as performanceUpdatePayload, z as performanceCreatePayload, C as useParams, g as useNavigate, S as Skeleton, A as ArrowLeft } from "./index-BIeIRmcz.js";
import { A as Activity, T as TrendingUp } from "./trending-up-B9tTcmkl.js";
import { P as Plus, M as MessageCircle, D as Download, a as Pencil, R as Root$1, I as Item, c as createRovingFocusGroupScope } from "./index-COqLEI9e.js";
import { T as Trash2, R as Root, C as Content$1, h as Close, i as Title, j as Portal, O as Overlay, A as AlertDialog, k as AlertDialogTrigger, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction, P as Presence } from "./alert-dialog-ZxV0vEOU.js";
import { I as Input, s as useMutation, a as useDirection, m as useControllableState, b as Primitive, n as useId, c as composeEventHandlers, d as createContextScope, t as useIntern, v as useLogWhatsApp, w as useUpdateDocumentState, q as useDeleteIntern } from "./use-interns-BFWCeDk_.js";
import { L as Label$1, T as Textarea, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./textarea-BiCHJ1Hi.js";
import { a as useActivities } from "./use-dashboard-BgAVUAdU.js";
...
function formatRelative(date2) {
  ...
  const diff = now2.getTime() - date2.getTime();
...
function ActivityLog({ activities }) {
  const sorted = [...activities].sort(
    (a2, b2) => b2.timestamp.getTime() - a2.timestamp.getTime()
  );
...
function formatDate(date2) {
  const d2 = date2 ? new Date(date2) : /* @__PURE__ */ new Date();
...
function buildCertificateHtml(intern) {
  ...
  const certId = `TMT-${intern.name.split(" ").map((n2) => n2[0]).join("").toUpperCase()}-${intern.joiningDate.getFullYear()}`;
  return `
<!DOCTYPE html>
<html lang="en">
<head>
...
function EmailComposeModal({
  ...
  reactExports.useEffect(() => {
    if (open) {
      const t2 = TEMPLATES.includes(defaultSubject) ? defaultSubject : "Custom";
      setActiveTemplate(t2);
      setTo(`${internName} <${internEmail}>`);
      setCc("");
      setSubject(
        TEMPLATE_SUBJECTS[t2] || (t2 === "Custom" ? defaultSubject : "")
      );
      setBody(TEMPLATE_BODIES[t2].replace(/\{name\}/g, internName));
    }
  }, [open, defaultSubject, internEmail, internName]);
  const applyTemplate = (t2) => {
    setActiveTemplate(t2);
    setSubject(
      TEMPLATE_SUBJECTS[t2] || (t2 === "Custom" ? "" : TEMPLATE_SUBJECTS[t2])
    );
    setBody(TEMPLATE_BODIES[t2].replace(/\{name\}/g, internName));
  };
  const handleSend = () => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground uppercase tracking-wide", children: "Quick Template" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: TEMPLATES.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => applyTemplate(t2),
                className: `px-3 py-1 rounded-full text-xs font-medium border transition-colors ${activeTemplate === t2 ? "bg-primary text-primary-foreground border-primary" : "bg-muted text-muted-foreground border-border hover:border-primary/50 hover:text-foreground"}`,
                "data-ocid": `intern_detail.email_template_${t2.toLowerCase().replace(/ /g, "_")}`,
                children: t2
              },
              t2
            )) })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "email-to",
                value: to,
                onChange: (e3) => setTo(e3.target.value),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "email-cc",
                value: cc,
                onChange: (e3) => setCc(e3.target.value),
                className: "bg-muted border-border text-sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                id: "email-body",
                value: body,
                onChange: (e3) => setBody(e3.target.value),
                rows: 8,
...
function useAddPerformance() {
  ...
  return useMutation({
    ...
    onError: (e3) => ue.error(e3.message || "Failed to add performance record")
  });
}
function useUpdatePerformance() {
  ...
  return useMutation({
    ...
    onError: (e3) => ue.error(e3.message || "Failed to update performance record")
  });
}
function useDeletePerformance() {
  ...
  return useMutation({
    ...
    onError: (e3) => ue.error(e3.message || "Failed to delete performance record")
  });
}
...
function autoOverall(f2) {
  return +((f2.taskScore + f2.attendanceScore + f2.communicationScore + f2.initiativeScore) / 4).toFixed(2);
}
function ScoreInput({
  label,
  name,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground uppercase tracking-wide", children: label }),
...
function AddEditModal({
  ...
  const set = (k2, v2) => {
    setForm((prev) => {
      const next = { ...prev, [k2]: v2 };
      if (k2 !== "overallScore") next.overallScore = autoOverall(next);
      return next;
    });
  };
  const handleSubmit = () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground uppercase tracking-wide", children: "Month" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  value: String(form.month),
                  onValueChange: (v2) => set("month", Number(v2)),
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      SelectTrigger,
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "bg-card border-border max-h-60 overflow-y-auto", children: MONTHS.map((m2, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: String(i + 1), children: m2 }, m2)) })
                  ]
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground uppercase tracking-wide", children: "Year" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
                  value: form.year,
                  onChange: (e3) => set("year", Number(e3.target.value)),
                  className: "bg-muted border-border",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ScoreInput,
            {
              ...
              onChange: (v2) => set("attendanceScore", v2)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ScoreInput,
            {
              ...
              onChange: (v2) => set("communicationScore", v2)
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ScoreInput,
            {
              ...
              onChange: (v2) => set("initiativeScore", v2)
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground uppercase tracking-wide", children: "Admin Notes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                value: form.adminNotes,
                onChange: (e3) => set("adminNotes", e3.target.value),
                rows: 3,
...
function PerformanceTab({
  ...
  const sorted = [...performances].sort(
    (a2, b2) => a2.year !== b2.year ? a2.year - b2.year : a2.month - b2.month
  );
  const last6 = sorted.slice(-6);
  const chartData = last6.map((p2) => ({
    name: `${MONTHS[p2.month - 1].slice(0, 3)} ${p2.year}`,
    task: p2.taskScore,
    attendance: p2.attendanceScore,
    communication: p2.communicationScore,
    initiative: p2.initiativeScore
  }));
  const openAdd = () => {
    setEditRecord(null);
    setModalOpen(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", "data-ocid": "intern_detail.performance_panel", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5", children: [
      ...
      sorted.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: sorted.map((p2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "py-2.5 pr-4 font-medium", children: [
                MONTHS[p2.month - 1].slice(0, 3),
                " ",
                p2.year
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4 text-muted-foreground", children: p2.taskScore }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4 text-muted-foreground", children: p2.attendanceScore }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4 text-muted-foreground", children: p2.communicationScore }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4 text-muted-foreground", children: p2.initiativeScore }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-primary", children: p2.overallScore.toFixed(1) }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 pr-4 max-w-[120px] truncate text-muted-foreground text-xs", children: p2.adminNotes || "—" }),
...
function InternAvatar({ intern }) {
  ...
  const initials = intern.name.split(" ").slice(0, 2).map((n2) => n2[0]).join("").toUpperCase();
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", "data-ocid": "intern_detail.tabs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "overview", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(OverviewTab, { intern }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "performance", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            PerformanceTab,
            {
              internId: id,
              performances,
              onAdd: (p2) => addPerformance.mutate(p2),
              onUpdate: (pid, p2) => updatePerformance.mutate({ id: pid, payload: p2 }),
